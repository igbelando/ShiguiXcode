...
class PlaceAnnotationNode: LocationNode {
    ...
    private func initializeUI(){
        ...
        plane.firstMaterial?.diffuse.contents = UIColor(red: 56/255, green: 151/255, blue: 217/255, alpha: 1)
        ...
        text.isWrapped = true
        text.font = UIFont(name: "Orbitron-Bold", size: 1.0)
        text.alignmentMode = kCAAlignmentCenter
        text.truncationMode = kCATruncationMiddle
        text.firstMaterial?.diffuse.contents = UIColor.white
        text.firstMaterial?.ambient.contents = UIImage(named: "Star")
